    ...
    public class BomberSquadPlaytestBridge : IPlaytestGameState, IPlaytestInputReceiver
    {
        ...
        private JObject BuildGameModeInfo(GameManager gm)
        {
            ...
            return new JObject
            {
                ...
                ["roundWinCondition"] = mode.roundWinCondition.ToString(),
                ["gameWinCondition"] = mode.gameWinCondition.ToString(),
                ["numberOfRounds"] = mode.numberOfRounds,
                ["pointsToWinGame"] = mode.pointsToWinGame,
                ["roundDuration"] = mode.roundDuration,
                ["killsToWinRound"] = mode.killsToWinRound,
                ...
                ["allowRespawn"] = mode.allowRespawn,
